...
#     if business_type == "restaurant": # for restaurants which is post-pay
#         keyboard = [
#             ["🍽 Order Food", "📦 Track Order"],
#             ["📞 Contact Staff", "🛍️✅💳 Checkout/Pay"]
#         ]

#     elif business_type == "vendor": # for vendors and hotels which is pre-pay
...
#     elif business_type == "hotel": # for hotels which is pre-pay
#         keyboard = [
#             ["🍽 Order Food", "📦 Track Order"],
#             ["📞 Contact Staff"]
#         ] 
