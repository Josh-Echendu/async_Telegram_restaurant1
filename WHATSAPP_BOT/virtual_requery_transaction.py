...
def virtual_account_requery_transaction(transaction_ref, max_retries=3):
...
virtual_account_requery_transaction(transaction_ref="REF-e5289fab6ab24b67b816f128a24c8754-5680916028")
